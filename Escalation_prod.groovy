...
Map<String, Object> params = Map.of("tenantId", payload.get("tenantId").asLong(), "ruleId", payload.get("ruleId").asLong(), "userId", user.get("tenantUserId").asLong(),"createDate",date,"escalation",false)
